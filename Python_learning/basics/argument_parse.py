...
def parse_path():
    ...
    # 添加可选参数
    parser.add_argument('--from_path', type=str, help='Source path to read from')
    parser.add_argument('--to_path', type=str, help='Destination path to write to')
    ...
    if args.from_path and args.to_path:
        ...
        args.from_path = unknown[0]
        args.to_path = unknown[1]
    else:
        print("Please provide valid paths using --from_path and --to_path or directly as positional arguments.")
        sys.exit(1)

    print(f"Copying from {args.from_path} to {args.to_path}...")
